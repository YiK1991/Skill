...
3. PD + JIT DELIVERABLES (add to the plan):
...
4. DISCOVERY/READING DELIVERABLES (Static vs Dynamic):
...
9. INVESTIGATION OUTPUTS (if any):
...
10. PARALLEL WORK PLAN (only if triggered):
